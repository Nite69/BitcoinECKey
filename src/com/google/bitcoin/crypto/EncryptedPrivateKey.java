...
public class EncryptedPrivateKey {
    ...
    public int hashCode() {
        ...
        Object[] array = new Object[]{encryptedPrivateBytes,initialisationVector};
    ...
    public boolean equals(Object obj) {
        ...
        if (!((this.initialisationVector == null) && (other.initialisationVector==null)))
        {
        	if (this.initialisationVector == null) return false;
        	if (other.initialisationVector == null) return false;
        	if (!this.initialisationVector.equals(other.initialisationVector)) return false;
        }
        if (!((this.encryptedPrivateBytes == null) && (other.encryptedPrivateBytes==null)))
        {
        	if (this.encryptedPrivateBytes== null) return false;
        	if (other.encryptedPrivateBytes == null) return false;
        	if (!this.encryptedPrivateBytes.equals(other.encryptedPrivateBytes)) return false;
        }
        return true;
